...
const Contact = () => {
    return (
        <scetion className="contact container section" id="contact">
            ...
            <div className="contact__container grid">
                ...
                <form action="" className="contact__form">
                    ...
                    <div className="contact__form-div contact__form-area">
                        <textarea name="" id="" cols="30" rows="10" className='contact__form-input' placeholder='Write your messenge'></textarea>
                    </div>
                    
                    <button className="btn">Send Messenge</button>
                </form>
            </div>
        </scetion>
    )
